...
describe("dogfood tracking issue sync", () => {
  ...
  it("dry-runs by writing a current-alpha tracking issue body without editing GitHub", async () => {
    ...
    expect(body).toContain("npm run dogfood:prepare-alpha -- --release-url https://github.com/Sskift/skfiy/releases/tag/skfiy-alpha-abcdef1 --tester-id tester-1 --workflows coding-terminal,screenshot-inspection --execute");
