...
function renderDashboardScript(): string {
  return [
    ...
    "    const classifier = [turn.denialKind, turn.routeReason, turn.reason, turn.latestMessage, turn.message, detail, turn.updateSource].filter(Boolean).join(\" \").toLowerCase();",
