...
function renderDashboardScript(): string {
  return [
    ...
    "    if (value === \"chrome-host-policy-denied\" || value === \"chrome_host_policy_blocked\" || value === \"chrome-host-policy-blocked\" || value === \"blocked_by_chrome_host_policy\" || value === \"blocked-by-chrome-host-policy\" || value === \"denied_by_chrome_host_policy\" || value === \"denied-by-chrome-host-policy\") return \"chrome_host_policy_denied\";",
