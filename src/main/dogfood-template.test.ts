...
describe("skfiy dogfood issue template", () => {
  ...
  it("requires dogfood reports to include alpha, smoke, permission, voice, and screenshot evidence", () => {
    ...
    const requiredEvidence = [
      ...
      "testerId, workflows, all five smoke artifact paths, app bundle preflight, and labels",
      "missing artifact paths or missing/mismatched app bundle preflight are rejected",
      ...
      "issue alpha manifest/zip/commit identity",
      "source commit matching",
