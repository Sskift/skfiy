...
- [ ] Internal dogfood with 3-5 real users:
  ...
  - [x] `dogfood:cohort` workflow coverage now counts only source/artifact/UI-pet-drag/permission/identity-eligible real tester reports
