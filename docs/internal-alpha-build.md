...
If the destination app already exists, the command validates its identity and reuses it so multiple tester handoffs for the same alpha can be prepared without destructive reinstalling.
