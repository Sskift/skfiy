...
4. Keep plan/doc hygiene green: one active plan, no retired dated plan docs, no stale handoff/checklist Markdown, and no workflow references to old plan paths.
