...
- React Activity evidence summary now renders the compact handoff contract endpoint, token-free flag, and source from `/api/evidence-summary` without exposing dashboard URL tokens.
