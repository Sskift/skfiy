...
- `npm run smoke:desktop-session -- --output .skfiy-smoke/desktop-session-8fc5ef5.json` records `result: "blocked"` with Screen Recording and Accessibility granted, `frontmostBundleId: "com.apple.loginwindow"`, `ioConsoleLocked: true`, `mainDisplayAsleep: true`, and a black screenshot.
